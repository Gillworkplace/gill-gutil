 ...
 * ObjectUtil
 *
 * &#064;copy from io.netty.util.internal.ObjectUtil
 **/
public class ObjectUtil {
     ...
     *
     * If it is, throws {@link NullPointerException}. Otherwise, returns the argument.
     */
    ...
    /**
     * Checks that the given argument is not null. If it is, throws {@link IllegalArgumentException}. Otherwise, returns
     * the argument.
     */
    ...
    /**
     * Checks that the given argument is in range. If it is not, throws {@link IllegalArgumentException}. Otherwise,
    ...
    /**
     * Checks that the given argument is neither null nor empty. If it is, throws {@link NullPointerException} or
    ...
    /**
     * Trims the given argument and checks whether it is neither null nor empty. If it is, throws
     * {@link NullPointerException} or {@link IllegalArgumentException}. Otherwise, returns the trimmed argument.
     *
